  ...
  _createClass(CleanCommand, [{
    ...
    value: function initialize(callback) {
      ...
      if (this.flags.includeFilteredDependencies) {
        this.packagesToClean = _PackageUtilities2.default.addDependencies(this.packagesToClean, this.packageGraph);
      }

      if (this.flags.yes) {
        callback(null, true);
      } else {
        this.logger.info("About to remove the following directories:\n" + this.packagesToClean.map(function (pkg) {
    ...
    value: function execute(callback) {
      ...
      _progressBar2.default.init(this.packagesToClean.length);
    ...
    value: function rimrafNodeModulesInPackages(callback) {
      _async2.default.parallelLimit(this.packagesToClean.map(function (pkg) {
        return function (cb) {
